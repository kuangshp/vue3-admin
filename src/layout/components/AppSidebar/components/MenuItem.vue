<template>
  <div class="sidebar-item-container">
    ...
    <template v-if="isRenderSingleRoute && theOnlyOneChildRoute">
      <menu-item-link v-if="theOnlyOneChildRoute.title" :to="resolvePath(theOnlyOneChildRoute.path)">
        <el-menu-item :index="resolvePath(theOnlyOneChildRoute.path)">
          <i class="menu-icon" v-if="theOnlyOneChildRoute.icon" :class="theOnlyOneChildRoute.icon"></i>
    ...
    <el-submenu v-else :index="resolvePath(item.path)" popper-append-to-body>
      ...
      <menu-item v-for="child in item.children" :key="child.id" :is-nest="true" :item="child" :base-path="resolvePath(child.path)"> </menu-item>
    </el-submenu>
  </div>
</template>
