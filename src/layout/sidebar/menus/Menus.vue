<template>
  <div class="sidebar">
    <el-menu class="sidebar-el-menu" :default-active="onRoutes" :collapse="!isCollapse" background-color="#fff" text-color="#333" active-text-color="#3273dc" unique-opened @select="selectMenu" v-if="menuList.length">
